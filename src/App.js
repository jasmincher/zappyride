...
function App() {
  ...
  //if the rate that is the lowest matches rate selected by user return the if statement 
  //otherwise return the else statement
  const switchRates = () => {
    if (saveMore === rate) {
  ...
  return (
    <div className="App">
      ...
      {/* used getwaves.io to make this svg */}
      <svg
